package model.GameChallenge.differentComp;
...
public class AdventureGame {
    ...
    private record Location(String desc, Map<Compass, String> nextPlaces){ }
...
//        adventureMap.forEach((k,v) -> System.out.printf("%s:%s%n",k,v));
    ...
    public void visit(Location location){
        System.out.printf("*** You're standing %s ***%n",location.desc);
