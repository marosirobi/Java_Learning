package model.immutableClasses.external;

import model.immutableClasses.PersonImmutable;
import model.immutableClasses.hacker.PersonOfInterest;
...
//        PersonImmutable johnCopy = new PersonImmutable(john); // not a subclass
