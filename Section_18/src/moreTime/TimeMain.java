...
//        System.setProperty("user.timezone", "UTC");
        ...
        System.out.println("Number of zone ID's : " + ZoneId.getAvailableZoneIds().size());
        ...
        System.out.println("Your kids birthdate, LA time = " + dob.format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.MEDIUM)));

        ZonedDateTime dobSydney = ZonedDateTime.ofInstant(dobInstant, ZoneId.of("Australia/Sydney"));
        System.out.println("Your kids birthdate, Sydney time = " + dob.format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.MEDIUM)));

        ZonedDateTime DobHere = dobSydney.withZoneSameInstant(ZoneId.systemDefault());
        System.out.println("Your kids birthdate, Here time = " + DobHere.format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.MEDIUM)));
        ...
        System.out.println("Your 2nd kids birthdate, Here time = " + dob2.format(DateTimeFormatter.ofLocalizedDateTime(FormatStyle.MEDIUM)));
